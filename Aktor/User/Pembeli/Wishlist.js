...
import { NativeBaseProvider, ScrollView, Box, Text, VStack, HStack, ZStack, Image, AspectRatio, Pressable, Checkbox } from 'native-base'
            ...
            <HStack space={3}>
              ...
              <VStack>
                ...
                <Text bold color="#EFAF00" fontSize="xl">
                  RP. {data?.produk.hargaProduk} - RP. {data?.produk.hargaProduk2}
                </Text>
                </Box>
              </VStack>
              </Box>
